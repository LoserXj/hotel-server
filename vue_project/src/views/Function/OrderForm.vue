...
<!--    </el-breadcrumb>-->
    ...
    <el-card>
      <el-row :gutter="20">
        <!--        搜索功能-->
        <el-col :span="8">
          <el-input placeholder="请输入内容" v-model="queryInfo.query" clearable @clear="getOrderList"></el-input>

        </el-col>
        <el-button icon="el-icon-search" @click="getOrderList" style="color: red">搜索</el-button>
<!--        &lt;!&ndash;        管理端可以手动添加订单&ndash;&gt;-->
<!--        <el-col :span="4">-->
...
<!--        </el-col>-->
    ...
    <!-- 添加用户的对话框 -->
    <el-dialog title="添加订单" v-model:visible="addOrderVisible" width="50%" @close="addOrderClosed">
      <!-- 内容主体区域 -->
    ...
    <!-- 修改订单的对话框 -->
    <el-dialog title="修改订单" v-model:visible="editOrderVisible" width="50%" @close="editOrderClosed">
